...
<x-app-layout>
    <br>
        ...
        <div class="container">
                <a href="{{ route('login') }}" class="btn btn-dark">Ver lista de artículos</a>  
        </div>
        @endif
        <br>
        <div class="container">
                    ...
                    <tr>
                        <td>
                            <div class="card" style="width: 20rem;">
                                ...
                                <a href="{{ url('/londres') }}" class="btn btn-dark">Visitar</a>
                            </div>
                        </td>
                        <td>
                            <div class="card" style="width: 20rem;">
                ...
                <div class="row g-0">
                    ...
                    <div class="col-md-8">
                        ...
                        <table  style="margin: 0 auto; border-spacing:  20px 0px; border-collapse: separate;" >
                            <td>
                                <a href="#" class="btn btn-dark">Ver artículo</a>
                            </td>
                            <td>
                                <a href="#" class="btn btn-dark">Descargar pdf</a>
                            </td>
                        </table>
